...
## 关于查询gpu的一些设备属性，如一个块里最大开多大的线程数，各个memory的大小

    You can find out by running the **DeviceQuery** application included in the CUDA SDK
    eg:
    dir: NVIDIA_CUDA-8.0_Samples/1_Utilities/deviceQuery
